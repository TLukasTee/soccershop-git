    ...
    function EffectCards(_ref) {
      ...
      const setTranslate = () => {
        ...
        for (let i = 0; i < slides.length; i += 1) {
          ...
          231004: Removed. This causes blurriness to Chrome.
                It forces us to apply a translateZ(-1px) to .magazine-viewport .swiper-cards .swiper-zoom-container
                and it's not clickable in firefox/Safari again.
                It looks like firefox works fine now. Was it a bug that was fixed?
          */     
          /*end heyzine*/
